...
const UpdateItem = () => {
    const {name,recipe,price,category}=useLoaderData()
   const axiosPublic = useAxiosPublic();
    ...
    return (
        <div>
            <SectionTitle heading='Update Menu Item'subHeading='update info'></SectionTitle>
             <div>
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <button className='btn mt-4'>
                                    update menu Item <FaUtensils ml-4></FaUtensils>
                                </button>
                            </form>
                        </div>
        </div>
